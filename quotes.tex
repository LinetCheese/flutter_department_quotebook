...
\item \entry{Ну по факту. Если они поменяют конкретно бизнес-логику. То это обосармс. А если просто вложенность в ответе -- то это ок. Хоть и гемор для меня и я их ненавижу}{\dd}
\item \entry{-- С шифрованием... чего? -- Жопы}{\lm \& \sv}
\item \entry{-- Не знаю, что не так в женщинах с пенисами. -- Пенис. -- А я думал женщина...}{\lm \& \al}
\item \entry{Ну я ещё не дебажил, я принтил только}{\dd's Junior}
\item \entry{Пизда заживает быстрее гораздо, и не так больно}{Дед}
\item \entry{Я был черкашом, пока не переехал в Киев}{\al}
\item \entry{У нас на проекте навигатор 2.0 мы его сами писали}{Interviewee}
\item \entry{Блок ничего не должен знать про флаттер}{Interviewee}
\item \entry{Л [SOLID] - это принцип Лебовски}{Interviewee}
\item \entry{Секс для пидоров}{\kn}
\item \entry{Ну в фидбек, если что, добавлю, но ссылки никакие мы давать не будем, пошел он нахуй. Он мне не понравился}{\sk}
\item \entry{-- Какие есть методы у \texttt{StatefulWidget?} -- Ну, разные...}{Interviewee}
\end{itemize}
